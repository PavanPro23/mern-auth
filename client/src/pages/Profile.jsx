...
import { updateUserStart, updateUserFailure, signOut, updateUserSuccess, deleteUserStart, deleteUserFailure, deleteUserSuccess } from "../redux/user/userSlice"
        ...
        <div className="p-3 max-w-lg mx-auto">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <p className="text-sm self-center">
                    {imageError ? (
                        <span className="text-red-700">Error in Uploading the Image ( file size should be less than 2MB)</span>
